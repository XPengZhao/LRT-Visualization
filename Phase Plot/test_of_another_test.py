    ...
    def update_filter(self, tags):
        ...
        for num in new_tags:
            button = tk.Radiobutton(
                self.frame, text='Tag ' + str(num), variable=self.var, value=num, indicatoron=False,
                width=120, height=30, image=self.image, compound=tk.CENTER,
...
class PhasePlot:
    def __init__(self, frame):
        ...
        filter_frame = tk.LabelFrame(frame, text='Tag Filter', bg='white',
