...
const MQUrl = "ws://158.132.255.123:15674/ws"
const wholeWs =  new WebSocket(MQUrl)
const createWs = function (){
    return wholeWs
}
export const state = reactive({
    ...
    atnPic:"path://M482.1,293.3h60.8V677h-60.8z M512.5,617.1l-30.4-23.8v83.8h60.8v-83.8z M482.1,293.3v110.5c9.8,2,20,3,30.4,3,10.4,0,20.6-1,30.4-3V293.3h-60.8z "+
